...
![Coverage](https://img.shields.io/badge/coverage-55.8%25-brightgreen)
...
> Estado de calidad validado: **583 pruebas superadas, 71 omitidas y 55.83% de cobertura**. El workflow bloquea la compilación del APK si los tests fallan o la cobertura baja del 50%.
...
Abre `http://127.0.0.1:5000`. En una instalación nueva, la pantalla **Configuración inicial segura** solicita crear la contraseña personal del Desarrollador. No existe una contraseña predeterminada visible. El endpoint solo acepta loopback y se desactiva después del primer uso. `desarrollador` es una identidad reservada y ninguna cuenta staff o cliente puede reutilizar su contraseña.
...
```text
583 passed, 71 skipped
TOTAL 12494 statements, 5519 missing, 55.83% coverage
```
