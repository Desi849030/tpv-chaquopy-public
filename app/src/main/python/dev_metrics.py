...
var rb=document.getElementById('ram-bar');rb.style.width=d.ram_pct+'%';rb.className='bar-fill'+(d.ram_pct>80?' err':d.ram_pct>60?' warn':'');
document.getElementById('ram-val').className='val'+(d.ram_pct>80?' err':d.ram_pct>60?' warn':'');
document.getElementById('stor-val').textContent=d.storage_pct+'%';
var sb=document.getElementById('stor-bar');sb.style.width=d.storage_pct+'%';sb.className='bar-fill'+(d.storage_pct>80?' err':d.storage_pct>60?' warn':'');
document.getElementById('stor-val').className='val'+(d.storage_pct>80?' err':d.storage_pct>60?' warn':'');
