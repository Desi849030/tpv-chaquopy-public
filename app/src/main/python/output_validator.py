"""
output_validator.py — Guardrails de salida para la IA Agéntica.
Valida respuestas antes de enviarlas al usuario. Detecta errores logicos,
valores imposibles y datos inconsistentes.
