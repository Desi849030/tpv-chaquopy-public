...
> Total de endpoints declarados: **355** en **48** módulos.
> Generado: 2026-07-22
...
- [`modules/project_intelligence_bp.py`](#project-intelligence-bp) — 10 endpoints
...
| GET | `/api/dev/project/chaquopy` | `project_chaquopy` |  |
| GET | `/api/dev/project/diagrams` | `project_diagrams` |  |
| GET | `/api/dev/project/state-of-art` | `project_state_of_art` |  |
